...
namespace ClinicManagementSystem.Application.Features.Auth.Commands.Login
{
    public class LoginCommandHandler : IRequestHandler<LoginCommand, LoginResponseDto>
    {
        ...
        public async Task<LoginResponseDto> Handle(LoginCommand request, CancellationToken cancellationToken)
        {
            ...
            var generatedToken=await _tokenService.GenerateAccessTokenAsync(userId, request.Email, resualt.Roles, resualt.PatientId, resualt.EmployeeId, resualt.DoctorId);
